    ...
    <div className="welcome page">
        ...
        <Flex>
          <Form method="POST" id='inspectionreportform' onSubmit={handleSubmit}>
            ...
            <Flex gap="gap.small">
              <FormInput label="First name" name="firstName" id="first-name-inline" inline required  onChange={handleChange}/>
              <FormInput label="Last name" name="lastName" id="last-name-inline" inline required onChange={handleChange}/>
              <FormInput label="VIN" name="vin" id="vin-inline" inline required onChange={handleChange}/>
              <FormInput label="Registration #" name="regNbr" id="vrm-inline" inline required onChange={handleChange}/>
            </Flex>
            <h3>Fluid Levels</h3>
            <Flex gap="gap.small">
            ...
            <Flex gap="gap.medium">
              ...
              <FormDropdown label="Upholstry" name="upholstry" onChange={handleDropChange} items={['Satisfactory', 'Needs Attention']} defaultValue='Satisfactory' />
            ...
            <Flex gap="gap.medium">
              ...
              <FormDropdown label="Turn Signals" name="turnSignals" onChange={handleDropChange} items={['Satisfactory', 'Needs Attention']} defaultValue='Satisfactory' />
