...
//Venky added this for chatgpt integration, 
...
//Venky added this to make it easy for chatgpt integration.
app.use(cors({
  origin: '*'
}));
...
app.get('/records', function(req, res, next) {
  //console.log("hit records call");
    ...
    let sql =  
      ...
      "SR.vehicle_vin, " + 
      "SR.vehicle_vrm, " + 
      "SR.vehicle_manufacturer, " +
      "SR.vehicle_model, " + 
      "SR.vehicle_problem, " + 
      "SR.vehicle_repair_cost, " + 
      "SR.vehicle_repair_date, " + 
