...
public class SearchMovies {
	...
	public static final Map<String, List<String>> getFacets() throws Exception {
        ...
        SearchOptions options = new SearchOptions()
        		.setFacets("cast", "original_language", "genres", "keywords")
        		.setSearchFields("genres")
        	    .setTop(1);
        ...
        while( keys.hasNext()) {
        	...
        	for( FacetResult aFr : fr) {
        		facetVals.add(aFr.getAdditionalProperties().get("value") + " (" + aFr.getCount() + ") ");
        	}
